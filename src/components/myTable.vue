      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button  type="text" size="small" @click="tableOption.showDetail(scope)" v-if="tableOption.showDetailBtn">详情</el-button>
            <el-button  type="text" size="small" @click="tableOption.editDetail(scope)" v-if="tableOption.showEditBtn">编辑</el-button>
            <el-button  type="text" size="small" @click="tableOption.delete(scope)" v-if="tableOption.showDelBtn">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
