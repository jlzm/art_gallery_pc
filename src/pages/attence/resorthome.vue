    ...
    <div class="resorthome">
      ...
      <div class="dialog">
        <el-dialog :title="dialogTitle" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
          <el-form  :model="addForm" class="form-inline"  ref="addForm"  :label-position="'left'" label-width="80px" :rules="rule">
  ...
  data () {
    ...
    return {
      ...
      rule: {
        ...
        circle: [
          { validator: requireValidate, message: '请选择工作周期', trigger: 'change'},
...
.resorthome .dialog /deep/ .el-select,.resorthome .dialog /deep/ .el-date-editor {
  width: 100%;
}
