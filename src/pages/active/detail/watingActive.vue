    ...
    <div class="ctn">
      ...
      <div class="detail-inline">
        ...
        <div class="info-ctn">
          ...
          <div class="info">
            <div class="inline-label">上课地点:</div>
            <div>
        ...
        <div class="info-ctn">
          <div class="info">
            <div class="inline-label">报名人数:</div>
            <div>
              <span>{{detail.allarrive}}人</span>
            </div>
          </div>
          <div class="info">
            <div class="inline-label">上限人数:</div>
            <div>
              <span>{{detail.maxnum}}人</span>
            </div>
          </div>
          <div class="info">
            <div class="inline-label">活动状态:</div>
            <div>
        ...
        <div>
          <div class="dib">活动预热: {{detail.cdesc}}</div>
        </div>
        <div class="all-student info">
          <div class="inline-label">报名学员:</div>
          <div>
            <span>{{detail.sname}}</span>
          </div>
        </div>
        <div class="all-student info">
          <div class="inline-label">试听学员:</div>
          <div>
