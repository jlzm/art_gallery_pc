<template>
  <div class="activity">
    <div class="title-ctn" @click="changeNav">
      <div class="title" :class="activeNav === 'wating' && 'active'" data-nav='wating'>
        未开始
      </div>
      <div class="title" :class="activeNav === 'done' && 'active'" data-nav='done'>
        已结束
      </div>
    </div>
    <div class="content">
          ...
          <div class="search">
            <el-form :inline="true" :model="watingCourseForm" class="form-inline" ref="">
              ...
              <el-form-item label="课程名称">
                <el-input v-model="watingCourseForm.courseName" placeholder="输入课程名称" size="small" clearable></el-input>
              </el-form-item>
              <el-form-item>
                <el-button type="primary" icon="el-icon-search" size="small" @click="getActiveData">查询</el-button>
              </el-form-item>
            </el-form>
            <el-form :inline="true">
        ...
        <div class="done" v-else>
          <div class="search">
            <el-form :inline="true" :model="doneCourseForm" class="form-inline" ref="">
              <el-form-item label="课程名称">
                <el-input v-model="doneCourseForm.courseName" placeholder="输入课程名称" size="small" clearable></el-input>
              </el-form-item>
              <el-form-item>
                <el-button type="primary" icon="el-icon-search" size="small" @click="getActiveData(1)">查询</el-button>
              </el-form-item>
            </el-form>
            <el-form :inline="true">
              <el-form-item class="oprator">
        ...
        <el-dialog :title="dialog.title" :visible.sync="dialog.visible" :close-on-click-modal="false" width="500px">
          <el-form :model="activeForm" class="form-inline" ref="activeForm" :label-position="'left'" label-width="95px"
            ...
            <el-form-item label="所需课时" prop="period_need">
              <el-input-number v-model="activeForm.period_need" size="small" :min="0">
